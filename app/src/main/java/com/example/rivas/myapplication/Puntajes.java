...
public class Puntajes extends AppCompatActivity implements AdapterView.OnItemClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdaptadorJugador(Puntajes.this,MainActivity.listaJugadores);
